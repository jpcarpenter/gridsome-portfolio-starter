<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-center items-center py-8">
        <!-- <div>
        ...
        <ul
          class="uppercase tracking-wide font-bold w-full block flex-grow flex flex-initial justify-center lg:w-auto items-center mt-8 lg:mt-0"
        >
    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:jacob@jacobpaulcarpenter.com" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/jpcarpenter" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/jacobpcarpenter" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://www.instagram.com/jacobpcarpenter" target="_blank" class="text-white hover:text-gray-400">
